...
const features = [
  {
    ...
    description: "Our algorithm compares your GPA against 200+ universities to calculate real admission chances.",
  },
  {
    icon: Target,
  ...
  },
  {
    ...
    description: "Get tailored suggestions to strengthen your application — courses, extracurriculars, and more.",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/30">
      ...
      <section className="pt-32 pb-20 sm:pt-40 sm:pb-28 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-slate-900 font-heading leading-[1.1]">
              Your GPA.{" "}
            ...
            <p className="mt-6 text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed">
              Enter your GPAs and instantly see your chances of admission at every major U.S. university — with personalized tips to improve.
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-100 shadow-sm hover:shadow-md transition-shadow"
              >
                <div className="w-11 h-11 rounded-xl bg-blue-50 flex items-center justify-center mb-5">
                  <feature.icon className="w-5 h-5 text-blue-600" />
                </div>
                <h3 className="text-lg font-semibold text-slate-900 mb-2 font-heading">{feature.title}</h3>
      ...
      <section className="pb-24 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 font-heading">How It Works</h2>
          <p className="mt-3 text-slate-500">Three simple steps to find your best-fit colleges</p>
        </div>
        <div className="max-w-4xl mx-auto grid sm:grid-cols-3 gap-8">
          {[
            { step: "01", title: "Enter Your GPAs", desc: "Provide your unweighted, weighted, academic, and 10-12 GPA." },
            ...
            >
              <div className="text-5xl font-bold text-blue-100 font-heading mb-3">{item.step}</div>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-100 bg-white/60 py-8 px-4">
