    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/30">
      ...
      <main className="pt-28 pb-20 px-4 sm:px-6">
        <div className="max-w-md mx-auto">
          ...
          >
            <Link to="/" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-blue-600 transition-colors mb-6">
            ...
            <p className="mt-2 text-slate-500 text-sm">
              Fill in your four GPA scores to see your admission chances across 200+ universities.
            </p>
          </motion.div>
